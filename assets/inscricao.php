		...
		<div class="inscricao-wrapper divs5050 dfl">
			...
			<div class="dir">
				<div class="wrapper-btn">
					...
					<a class="btn white brownhover" href=""/>Regulamento</a>
					<a class="btn white brownhover" href=""/>Apoio e Documentos para inscrição</a>
					<a class="btn white brownhover" href=""/>Dúvidas frequentes</a>
				</div>
			</div>
		</div>
	</div>
