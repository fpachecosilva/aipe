...
<section class="governanca">
	<div class="container dflt gap60">
		<div class="bloco1">
			<?php include 'assets/img/icons/pasta.php'; ?>
			<p class="subtitulo-generico">Governança e<br class="desk"> Transparência</p>
			<p class="texto-generico">Compromisso com integridade<br class="desk"> e sustentabilidade em tudo que fazemos.</p>
			<div class="wrapper-btn">
				<a class="btn brown sechover" href="https://aipe.org.br/documentos/documentos.zip"/>Acessar documentos</a>
			</div>
		</div>
		<div class="bloco2">
